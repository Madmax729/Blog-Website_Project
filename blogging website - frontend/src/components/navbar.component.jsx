...
const[searchBoxVisibility,setSearchBoxVisibility] = useState(false)
  ...
  return (
    ...
    {/* search box */}
        {/* <div className={"absolute bg-white w-full left-0 top-full mt-0 
        border-b border-grey py-4 px-[5vw] md:border-0
        md:block md:relative md:inset-0 md:p-0 md:w-auto show hide "+ (
            ...
            <div className={"absolute bg-white w-full left-0 top-full mt-0 border-b border-grey py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto md:show  " + (searchBoxVisibility ? "show" : "hide")}>
                ...
                <i className="fi fi-rr-search absolute left-[10%]
        ...
        onClick={()=>{setSearchBoxVisibility(currentVal => !currentVal)}}>
            ...
            <Link to='/editior' className="hidden md:flex gap-2 link">
